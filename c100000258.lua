...
function c100000258.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		c:RegisterEffect(e4)
		if Duel.CheckEvent(EVENT_ATTACK_ANNOUNCE) and Duel.GetAttackTarget()==tc and Duel.IsExistingTarget(Card.IsType,tp,LOCATION_GRAVE,0,1,nil,TYPE_MONSTER) then
